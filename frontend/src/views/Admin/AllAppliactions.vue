...
export default{
    ...
    methods:{
        ...
        ShowWaiting(){
            axios.get('https://localhost:5001/app/api/Application/waiting',
       ...
       ShowAccepted(){
            axios.get('https://localhost:5001/app/api/Application/accepted',
            {headers: {"Authorization": "Bearer " + localStorage.getItem('token')}
            })
            .then(res => {
                // console.log(res.data);
        ...
        ShowRejected(){
            axios.get('https://localhost:5001/app/api/Application/rejected',
            {headers: {"Authorization": "Bearer " + localStorage.getItem('token')}
            })
            .then(res => {
                // console.log(res.data);
        ...
        handleSubmitModalAccept() {
            ...
            axios.put('https://localhost:5001/app/api/Application/accept',acceptApplication, {headers: {
         ...
         handleSubmitModalReject() {
            ...
            axios.put('https://localhost:5001/app/api/Application/reject',rejectApplication, {headers: {
                "Authorization": "Bearer " + localStorage.getItem('token'),
                }} ).then(res => {
                    //if successfull
                    if(res.status === 200){
